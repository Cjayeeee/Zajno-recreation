...
// Locomotive still works everywhere
const locomotiveScroll = new LocomotiveScroll({
  el: document.querySelector('[data-scroll-container]'),
  smooth: !isMobile, // disable smooth on mobile for better performance
  lerp: 0.07
})

/* =====================================================
   DESKTOP ONLY — THREE.JS + SHADERS
===================================================== */

if (!isMobile) {

  // Dynamically import THREE + shaders (not bundled for mobile)
  Promise.all([
    import('three'),
    import('./shaders/vertex.glsl'),
    import('./shaders/fragment.glsl')
  ]).then(([THREE, vertexShader, fragmentShader]) => {
